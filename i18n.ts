...
const en: Record<string, string> = {
  ...
  shop_title: "Galeries Lafayette",
  shop_subtitle: "Discover Galeries Lafayette Haussmann, just 15 minutes away. VIP reception upon request.",
  shop_student_note: "Tax Refund service available for international guests.",
...
const fr: Record<string, string> = {
  ...
  "hub.student_guide": "Guide Client",
  ...
  "concierge.student": "Client Suite",
  ...
  "admin.label.cleaningStudent": "Service de Chambre",
  ...
  cleaning_2: "Service de chambre quotidien sur demande. Service supplémentaire disponible.",
  ...
  shop_title: "Galeries Lafayette",
  shop_subtitle: "Découvrez les Galeries Lafayette Haussmann, à seulement 15 minutes. Accueil VIP sur demande.",
  shop_student_note: "Service Tax Refund disponible pour les clients internationaux.",
  restaurant_title: "Restaurant & Bar",
